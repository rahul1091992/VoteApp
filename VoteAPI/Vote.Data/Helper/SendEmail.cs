   ...
   public static class SendEmail
    {
        public static bool SendForgotPasswordMail(string name, string email, string password)
        {
            ...
            try
            {
                ...
                mailmsg.From = new MailAddress("beesolvertechpvtltd@gmail.com");
                mailmsg.Subject = "Password Detail:- Luckydraw Application";
                ...
                mailmsg.Body += "<br />";
                mailmsg.Body += "System Administrator Luckydraw Application";
                mailmsg.Body += "<br />";
                ...
                if (mailTo.Length > 0)
                {
                    ...
                    SmtpServer.Credentials = new NetworkCredential(mailmsg.From.Address, "Beesolver@Tech");
